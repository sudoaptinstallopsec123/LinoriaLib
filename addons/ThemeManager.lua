...
LPH_NO_VIRTUALIZE(function()
	...
	do
		...
		ThemeManager.BuiltInThemes = {
            ["Default"] = {
				...
				httpService:JSONDecode(
					'{"FontColor":"bbbbbb","MainColor":"171717","AccentColor":"eac9cf","BackgroundColor":"171717","OutlineColor":"2c2c2c"}'
				),
			},
			["Yellow"] = {
				1,
			...
			["Secondary"] = {
				2,
				httpService:JSONDecode(
					'{"FontColor":"89919c","MainColor":"20232a","AccentColor":"898aae","BackgroundColor":"161a20","OutlineColor":"25262d"}'
				),
			},
			["BBot"] = {
				3,
		...
		function ThemeManager:LoadDefault()
			...
			if isDefault and Options.ThemeManager_ThemeList then
		...
		function ThemeManager:CreateThemeManager(groupbox)
			...
			groupbox
				:AddLabel("Disabled color")
				:AddColorPicker("DisabledColor", { Default = self.Library.DisabledColor })
			...
			Options.DisabledColor:OnChanged(UpdateTheme)
		end
		...
		function ThemeManager:SaveCustomTheme(file)
			...
			local theme = {}
			local fields = { "FontColor", "MainColor", "AccentColor", "BackgroundColor", "OutlineColor", "RiskColor", "DisabledColor" }
